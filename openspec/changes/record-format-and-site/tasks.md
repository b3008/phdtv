...
- [ ] 2.1 Write `disciplines.yaml` with the 42 OECD Frascati minor fields as slugs, display names and major-field parents; verify a test asserts 42 entries with unique slugs and valid parents
