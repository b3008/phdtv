...
> **Update 2026-09-06**: all of this landed the same day, including the TV-guide look — the spec's Look section was rewritten around the third round before the stylesheet task ran. See [The calendar lands](2026-09-06-04-calendar-views-landed.md).
...
> **Update 2026-09-06**: the window clamp is real, but device-metrics emulation over the DevTools protocol is not bound by it; a page can be laid out at a true 320px without an iframe. See [Down to 320 pixels](2026-09-06-07-responsive-to-320.md).
