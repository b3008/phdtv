...
export function fixtureDefense(overrides: DefenseOverrides = {}): Defense {
  return withoutUndefined({
    ...
    university: { slug: 'tudelft', name: 'Delft University of Technology', country: 'NL', website: 'https://www.tudelft.nl/' },
    faculty: 'Electrical Engineering, Mathematics and Computer Science',
    disciplines: [{ slug: 'computer-and-information-sciences', name: 'Computer and information sciences' }],
    language: 'en',
